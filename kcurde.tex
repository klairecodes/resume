...
\cvtag{C}\cvtag{Linux}\cvtag{Apache}\cvtag{PostgreSQL}\cvtag{HTML/CSS}\cvtag{JS} \medskip

\cvproject{Software Engineer Co-op}{Bryx Inc.}
{
\begin{itemize}
...
\cvtag{TypeScript}\cvtag{React}\cvtag{Semantic UI} \medskip
...
{} \
\cvtag{Rust}\cvtag{gRPC}\cvtag{Protobuf}\cvtag{Podman}\cvtag{SQLx}\cvtag{S3}\medskip
