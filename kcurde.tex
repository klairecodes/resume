...
\begin{document}
\name{KLAUS CURDE}
\tagline{Seeking a Software and/or DevOps Engineer Co-op.}
\personalinfo{%
...
\cvproject{DevOps Engineer Co-op}{Council Rock - Vista}
{
\begin{itemize}
    \item Maintained a custom RKE Kubernetes deployment of the Thingsboard application and our integrations.
    \item Developed a new Docker Compose deployment.
    \item Maintained a Proxmox instance, and set up a build server with optimized multi-stage BuildKit builds.
\end{itemize}
}
...
{} \
\cvtag{C++}\cvtag{Electronics}\cvtag{Robotics}\cvtag{Arduino}
